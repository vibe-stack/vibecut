  ...
  const dndContext = useMemo(
    () => ({ 
      ...
      onDragStart: (e: DragStartEvent) => {
        console.log('DndContext onDragStart called', e);
        onDragStart(e);
      },
      onDragOver: (e: DragOverEvent) => {
        console.log('DndContext onDragOver called', e);
        onDragOver(e);
      },
      onDragMove: (e: DragMoveEvent) => {
        console.log('DndContext onDragMove called', e);
        onDragMove(e);
      },
      onDragEnd: (e: DragEndEvent) => {
        console.log('DndContext onDragEnd called', e);
        onDragEnd(e);
      },
